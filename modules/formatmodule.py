...
class prints:
    ...
    def title(self):
        ...
        print(f"{bcolors.OKGREEN}      $$ |                             $$ |                        $$ |{bcolors.ENDC}")
        print(f"{bcolors.OKGREEN} $$$$$$$ | $$$$$$\   $$$$$$\         $$$$$$\    $$$$$$\   $$$$$$\  $$ |{bcolors.ENDC}")
        print(f"{bcolors.OKGREEN}$$  __$$ | \____$$\ $$  __$$\ $$$$$$\\_$$  _|  $$  __$$\ $$  __$$\ $$ |{bcolors.ENDC}")
        print(f"{bcolors.OKGREEN}$$ /  $$ | $$$$$$$ |$$ /  $$ |\______| $$ |    $$ /  $$ |$$ /  $$ |$$ |{bcolors.ENDC}")
        print(f"{bcolors.OKGREEN}$$ |  $$ |$$  __$$ |$$ |  $$ |         $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |{bcolors.ENDC}")
        print(f"{bcolors.OKGREEN}\$$$$$$$ |\$$$$$$$ |\$$$$$$$ |         \$$$$  |\$$$$$$  |\$$$$$$  |$$ |{bcolors.ENDC}")
        print(f"{bcolors.OKGREEN} \_______| \_______| \____$$ |          \____/  \______/  \______/ \__|{bcolors.ENDC}")
        print(f"{bcolors.OKGREEN}                          $$ |                                         {bcolors.ENDC}")
        print(f"{bcolors.OKGREEN}                          $$ |                                         {bcolors.ENDC}")
        print(f"{bcolors.OKGREEN}                          \__|                                         {bcolors.ENDC}")
